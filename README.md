...
A Website which helps programmers to name things.

Give a description of variables, classes, objects and methods etc. and get name suggestions


## Demo

[Live view](https://helpmename.netlify.app/) of the project.
